...
layer_2 = dense_layer(layer_1, 500) # 250
layer_3 = dense_layer(layer_2, 500) # 50
layer_4 = dense_layer(layer_3, 500) # 250
layer_5 = dense_layer(layer_4, 500) # 500
layer_6 = dense_layer(layer_5, 784)

with tf.name_scope('loss'):
    softmax_cross_entropy = tf.nn.sigmoid_cross_entropy_with_logits(labels=y_input, logits=layer_6)
...
y_input_reshaped = tf.reshape(x_input, [-1, 28, 28, 1])
